...
function TablePochtaRfEmployees({ handleCustomModal, data }) {
  return (
    <div className="accordion_table" style={{ margin: "0 0 10px 0" }}>
      <div className="accordion_table_head">
        <Title Tag="h3">Таблица Почта россии сотрудники</Title>
      ...
      {data?.post ? (
        <Card>
          <div className="details_div">
            <div className="details_label">Должность</div>
            <p>{data?.post}</p>
          </div>
        </Card>
      ) : null}
...
export default TablePochtaRfEmployees;
